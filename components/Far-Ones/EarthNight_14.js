...
const EarthNight_14 = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      camera.position.x =
        20 * Math.sin(Date.now() * 0.001) * Math.cos(Date.now() * 0.002) + 50;
      camera.position.y =
        10 * Math.sin(Date.now() * 0.003) * Math.cos(Date.now() * 0.004) + 50;
      camera.position.z = 5 * Math.cos(Date.now() * 0.001) + 30;
